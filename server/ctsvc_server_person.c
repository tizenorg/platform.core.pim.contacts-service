...
static int __ctsvc_get_aggregation_suggestions(int person_id, GSList *contact_ids, contacts_list_h *out_list)
{
	int ret = CONTACTS_ERROR_NONE;
	GSList *cursor = NULL;
	char *query = NULL;
...
int ctsvc_person_get_aggregation_suggestions(int person_id, contacts_list_h *out_list)
{
	...
	ret =  __ctsvc_get_aggregation_suggestions(person_id, contact_ids, out_list);
