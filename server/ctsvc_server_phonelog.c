		...
		int candidate_person_id, bool person_link)
{
	...
	while ((ret = ctsvc_stmt_step(get_log))) {
		...
		if (number && old_person_id <= 0 && 0 < candidate_person_id) {
			__ctsvc_db_phone_log_find_person_id(address, normal_address, minmatch_address,
						candidate_person_id, &new_number_type);
			...
			new_person_id = __ctsvc_db_phone_log_find_person_id(address, normal_address,
					minmatch_address, -1, &new_number_type);
			...
			new_person_id = __ctsvc_db_phone_log_find_person_id(address, normal_address,
					minmatch_address, old_person_id, &new_number_type);
			...
			temp_id = __ctsvc_db_phone_log_find_person_id(address, normal_address,
					minmatch_address, candidate_person_id, &new_number_type);
