...
API int contacts_person_get_aggregation_suggestions(int person_id, contacts_list_h *out_list)
{
	int ret;
	contacts_h contact = NULL;
	...
	ret = ctsvc_client_person_get_aggregation_suggestions(contact, person_id, out_list);
