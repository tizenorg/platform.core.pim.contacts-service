...
//	{CTSVC_VIEW_URI_GROUPRELS_UPDATED_INFO, NULL},
	...
	{CTSVC_VIEW_URI_READ_ONLY_PERSON_COMPANY, CTSVC_DB_VIEW_PERSON_COMPANY, CTSVC_PERMISSION_CONTACT_READ, CTSVC_PERMISSION_CONTACT_NONE},
	{CTSVC_VIEW_URI_READ_ONLY_PERSON_URL, CTSVC_DB_VIEW_PERSON_URL, CTSVC_PERMISSION_CONTACT_READ, CTSVC_PERMISSION_CONTACT_NONE},
	{CTSVC_VIEW_URI_READ_ONLY_PERSON_NICKNAME, CTSVC_DB_VIEW_PERSON_NICKNAME, CTSVC_PERMISSION_CONTACT_READ, CTSVC_PERMISSION_CONTACT_NONE},
	{CTSVC_VIEW_URI_READ_ONLY_PERSON_MESSENGER, CTSVC_DB_VIEW_PERSON_MESSENGER, CTSVC_PERMISSION_CONTACT_READ, CTSVC_PERMISSION_CONTACT_NONE},
	{CTSVC_VIEW_URI_READ_ONLY_PERSON_EVENT, CTSVC_DB_VIEW_PERSON_EVENT, CTSVC_PERMISSION_CONTACT_READ, CTSVC_PERMISSION_CONTACT_NONE},
	{CTSVC_VIEW_URI_READ_ONLY_PERSON_UNKNOWN, CTSVC_DB_VIEW_PERSON_INCLUDE_UNKNOWN, CTSVC_PERMISSION_CONTACT_READ, CTSVC_PERMISSION_CONTACT_NONE},
...
static int __ctsvc_db_create_views()
{
	...
	// CTSVC_DB_VIEW_PERSON_COMPANY
	snprintf(query, sizeof(query),
		"CREATE VIEW IF NOT EXISTS "CTSVC_DB_VIEW_PERSON_COMPANY" AS "
			"SELECT * FROM "CTSVC_DB_VIEW_PERSON_CONTACT" "
			"JOIN (SELECT "
								"contact_id, "
								"is_default, "
	...
	// CTSVC_DB_VIEW_PERSON_URL
	snprintf(query, sizeof(query),
		"CREATE VIEW IF NOT EXISTS "CTSVC_DB_VIEW_PERSON_URL" AS "
			"SELECT * FROM "CTSVC_DB_VIEW_PERSON_CONTACT" "
			"JOIN (SELECT "
								"contact_id, "
								"data1 type, "
	...
	// CTSVC_DB_VIEW_PERSON_NICKNAME
	snprintf(query, sizeof(query),
		"CREATE VIEW IF NOT EXISTS "CTSVC_DB_VIEW_PERSON_NICKNAME" AS "
			"SELECT * FROM "CTSVC_DB_VIEW_PERSON_CONTACT" "
			"JOIN (SELECT "
								"contact_id, "
								"data3 name "
	...
	// CTSVC_DB_VIEW_PERSON_EVENT
	snprintf(query, sizeof(query),
		"CREATE VIEW IF NOT EXISTS "CTSVC_DB_VIEW_PERSON_EVENT" AS "
			"SELECT * FROM "CTSVC_DB_VIEW_PERSON_CONTACT" "
			"JOIN (SELECT id, "
							"contact_id, "
							"data1 type, "
