...
typedef enum {
	...
	CTSVC_PROPERTY_CONTACT_SIP = (CTSVC_PROPERTY_CONTACT | CTSVC_VIEW_DATA_TYPE_STR) +30,
	...
	CTSVC_PROPERTY_MY_PROFILE_SIP = (CTSVC_PROPERTY_MY_PROFILE | CTSVC_VIEW_DATA_TYPE_STR) +20,
