...
typedef enum {
	...
	CTSVC_PROPERTY_PERSON_EXTRA_DATA1 = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_INT | CTSVC_READ_ONLY_PROPERTY) +15,
	CTSVC_PROPERTY_PERSON_EXTRA_DATA2 = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_STR | CTSVC_READ_ONLY_PROPERTY) +16,
