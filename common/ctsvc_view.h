...
#define CTSVC_VIEW_URI_READ_ONLY_PERSON_MESSENGER				"tizen.contacts_view.person/simple_contact/messenger"
#define CTSVC_VIEW_URI_READ_ONLY_PERSON_EVENT				"tizen.contacts_view.person/simple_contact/event"
#define CTSVC_VIEW_URI_READ_ONLY_PERSON_UNKNOWN				        "tizen.contacts_view.person/simple_contact/unknown"
...
#define CTSVC_VIEW_URI_READ_ONLY_PHONELOG_NUMBER					"tizen.contacts_view.phonelog/number"
#define CTSVC_VIEW_URI_READ_ONLY_PHONELOG_STAT						"tizen.contacts_view.phonelog_stat"

#define CTSVC_VIEW_URI_CONTACT_INCLUDE_UNKNOWN "tizen.contacts_view.contact_include_unknown"
...
typedef enum {
	...
	// person company
	CTSVC_PROPERTY_PERSON_COMPANY_IS_DEFAULT = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_INT | CTSVC_READ_ONLY_PROPERTY ) + 1,
	CTSVC_PROPERTY_PERSON_COMPANY_NAME = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_STR | CTSVC_READ_ONLY_PROPERTY ) + 2,
	CTSVC_PROPERTY_PERSON_COMPANY_DEPARTMENT = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_STR | CTSVC_READ_ONLY_PROPERTY ) + 3,
	CTSVC_PROPERTY_PERSON_COMPANY_JOB_TITLE = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_STR | CTSVC_READ_ONLY_PROPERTY ) + 4,
	...
	// person messenger
	CTSVC_PROPERTY_PERSON_MESSENGER_ID = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_INT | CTSVC_READ_ONLY_PROPERTY ) + 1,
	CTSVC_PROPERTY_PERSON_MESSENGER_IM_ID = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_STR | CTSVC_READ_ONLY_PROPERTY ) + 2,
	CTSVC_PROPERTY_PERSON_MESSENGER_LABEL = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_STR | CTSVC_READ_ONLY_PROPERTY ) + 3,
	CTSVC_PROPERTY_PERSON_MESSENGER_TYPE = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_INT | CTSVC_READ_ONLY_PROPERTY ) + 4,

	// person event
	CTSVC_PROPERTY_PERSON_EVENT_ID = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_INT | CTSVC_READ_ONLY_PROPERTY ) + 1,
	CTSVC_PROPERTY_PERSON_EVENT_TYPE = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_INT | CTSVC_READ_ONLY_PROPERTY ) + 2,
	CTSVC_PROPERTY_PERSON_EVENT_DATE = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_INT | CTSVC_READ_ONLY_PROPERTY ) + 3,
	CTSVC_PROPERTY_PERSON_EVENT_LABEL = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_STR | CTSVC_READ_ONLY_PROPERTY) + 4,

	CTSVC_PROPERTY_PERSON_UNKNOWN_DISPLAY_NAME = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_STR | CTSVC_READ_ONLY_PROPERTY ) + 1,
	CTSVC_PROPERTY_PERSON_UNKNOWN_IMAGE_THUMBNAIL = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_STR | CTSVC_READ_ONLY_PROPERTY ) + 2,
	CTSVC_PROPERTY_PERSON_UNKNOWN_DISPLAY_CONTACT_ID = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_INT | CTSVC_READ_ONLY_PROPERTY ) + 3,
	CTSVC_PROPERTY_PERSON_UNKNOWN_IS_FAVORITE = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_BOOL | CTSVC_READ_ONLY_PROPERTY ) + 4,
	CTSVC_PROPERTY_PERSON_UNKNOWN_LINK_COUNT = (CTSVC_PROPERTY_PERSON | CTSVC_VIEW_DATA_TYPE_INT | CTSVC_READ_ONLY_PROPERTY) + 5,
	...
	CTSVC_PROPERTY_CONTACT_IS_UNKNOWN = (CTSVC_PROPERTY_CONTACT | CTSVC_VIEW_DATA_TYPE_INT) +30,
	...
	CTSVC_PROPERTY_EVENT_IS_LUNAR = (CTSVC_PROPERTY_EVENT | CTSVC_VIEW_DATA_TYPE_BOOL) +5,
	CTSVC_PROPERTY_EVENT_LUNAR_DATE = (CTSVC_PROPERTY_EVENT | CTSVC_VIEW_DATA_TYPE_INT) +6,
	...
	CTSVC_PROPERTY_SDN_NAME = (CTSVC_PROPERTY_SDN | CTSVC_VIEW_DATA_TYPE_STR) +1,
	CTSVC_PROPERTY_SDN_NUMBER = (CTSVC_PROPERTY_SDN | CTSVC_VIEW_DATA_TYPE_STR) +2,
