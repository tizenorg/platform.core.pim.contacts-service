...
/**
 * @brief Gets the limit size of width and height of photos to append in vCard files.
 *
 * @since_tizen 3.0
 * @privlevel public
 * @privilege %http://tizen.org/privilege/contact.read
 *
 * @param[out]   limit_size             The limit size of width and height of photos to append in vCard files
 *
 * @return  @c 0 on success,
 *          otherwise a negative error value
 *
...
/**
 * @brief Sets the limit size of width and height of photos to append in vCard files.
 *
 * @since_tizen 3.0
 * @privlevel public
 ...
 *
 * @param[in]   limit_size             The limit size of width and height of photos to append in vCard files
 *
 * @return  @c 0 on success,
 *          otherwise a negative error value
 *
