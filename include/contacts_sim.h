 ...
 *
 * @remarks Use contacts_sim_import_all_contacts_by_sim_slot_no() instead.
 *
 ...
 *
 * @remarks Use contacts_sim_get_initialization_status_by_sim_slot_no() instead.
 *
...
/**
 * @brief Imports all contacts from SIM of sim_slot_no to Contacts Database.
 *
 * @since_tizen 3.0
 * @privlevel public
 * @privilege %http://tizen.org/privilege/contact.write
...
/**
 * @brief Checks whether SIM of sim_slot_no initialization is completed.
 *
 * @since_tizen 3.0
 * @privlevel public
 * @privilege %http://tizen.org/privilege/contact.read
